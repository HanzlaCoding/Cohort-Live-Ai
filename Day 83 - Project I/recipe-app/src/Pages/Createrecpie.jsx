...
const Createrecpie = () => {
  ...
  return (
    <>
     <div className="min-h-100 px-2 py-5 font-['Playfair_Display']">
  <div className="max-w-5xl mx-auto bg-white/80 backdrop-blur-md p-6 rounded-xl shadow-lg">
    <h1 className="text-3xl font-['Playfair_Display'] text-center mb-3">
      Express Your Recipe
    </h1>
    ...
    <form
      ...
      className="grid md:grid-cols-3 md:grid-rows-3 lg:grid-cols-4 gap-4 font-['Inter'] text-sm"
    >
      {/* Upload Image */}
      <div>
        ...
        <input
          ...
          type="text"
          placeholder="Add an image link please..."
      ...
      <div>
        ...
        <input
          ...
          type="text"
          placeholder="Add a title please..."
          className="w-full px-3 py-1.5 border border-gray-300 rounded focus:outline-none focus:ring focus:ring-amber-300 transition-all"
        />
        {errors.title && (
