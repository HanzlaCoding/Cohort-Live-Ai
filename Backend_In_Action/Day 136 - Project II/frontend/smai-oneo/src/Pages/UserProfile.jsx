          ...
          <div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-16">
            ...
            <div className="flex flex-col w-full">
              <div className="flex items-center space-x-4 mb-4">
                ...
                {/* Edit Profile Button */}
                <button className="bg-purple-500 hover:bg-purple-600 text-white text-sm font-semibold py-1 px-4 rounded-lg transition duration-200">
                  Edit Profile
                </button>
              </div>
              ...
              <div className="text-gray-800 mt-2">
                ...
                <p className="text-sm my-1">{userData.bio? "available":"not available"}</p>
                <a
